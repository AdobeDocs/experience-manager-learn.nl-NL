...
3. Klik vanuit de oplossingsschakelaar op **Starten** en selecteer vervolgens de **Ga naar starten** knop.
...
6. Geef een naam op voor de eigenschap (bijvoorbeeld *Zelfstudie AEM*)
...
1. Onder **Extensies** kunt u de lijst met extensies zien die al zijn geïnstalleerd voor de eigenschap Launch. ([Experience Platform Launch Core-extensie](https://exchange.adobe.com/experiencecloud.details.100223.adobe-launch-core-extension.html) is standaard geïnstalleerd)
...
5. Klikken **Opslaan** om het toevoegen van de uitbreiding van het Doel aan uw bezit van de Lancering te voltooien, en u zou nu de uitbreiding moeten kunnen zien van het Doel die onder wordt vermeld **Geïnstalleerd** lijst met extensies.
