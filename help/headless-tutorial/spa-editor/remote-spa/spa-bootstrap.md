...
Met het KUUROORD dat op [&#x200B; http://localhost :3000 loopt &#x200B;](http://localhost:3000), open het gebruikend de Redacteur van AEM SPA. Niets is editable in het KUUROORD nog, bevestigt dit slechts het KUUROORD in AEM.
