...
Maak een AEM-project waarin configuraties en basislijninhoud worden beheerd. Dit project wordt gegenereerd in de map `aem-guides-wknd-graphql` van het gekloonde `remote-spa-tutorial` project.
