...
1. Verifieer de registratie van het nieuwe Verschuivende Model door aan [ http://localhost :4502 te navigeren/system/console/status-slingmodels ](http://localhost:4502/system/console/status-slingmodels).
