...
1. In browser navigeert aan [ http://localhost :4502 /content/wknd-spa-angular/us/en.model.json ](http://localhost:4502/content/wknd-spa-angular/us/en.model.json).
...
7. Open het dossier `ui.frontend/package.json` en voeg een nieuw **begin:mock** bevel toe om het {**dossier 3} proxy.mock.conf.json van verwijzingen te voorzien.**
