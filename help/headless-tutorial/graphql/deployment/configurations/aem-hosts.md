...
De aangepaste AEM headless-client (`api/Aem.swift`) bevat een methode `makeRequest(..)` dat AEM GraphQL APIs verzoeken met de gevormde AEM prefixen `scheme` en `host`.
