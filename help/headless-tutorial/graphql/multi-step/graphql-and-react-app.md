...
Dit is echter geen geschikte optie voor **productieplaatsing** maar werkt prima tijdens de ontwikkeling en meer details zijn te vinden op [_Implementatie_](../deployment/spa.md) sectie.
