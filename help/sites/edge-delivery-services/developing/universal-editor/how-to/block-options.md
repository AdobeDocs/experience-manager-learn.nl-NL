---
title: Blokopties
description: Ontwikkel een blok dat kan worden geschakeld om verschillende verschijningen en gedrag te hebben.
...
Zodra het blok van het Taser aan de pagina wordt toegevoegd, [ publiceert de pagina aan voorproef ](../6-author-block.md) gebruikend **Publicaties** en Admin van de Plaats van de Auteur van AEM beheren.
