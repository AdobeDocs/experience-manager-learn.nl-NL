...
description: De volgende video biedt een overzicht van de basisafhandeling bij gebruik van de AEM-auteursomgeving. Het gebruikt de console van Plaatsen als basis.
...
De volgende video biedt een overzicht van de basisafhandeling bij gebruik van de AEM-auteursomgeving. Het gebruikt de console van Plaatsen als basis.
...
* Het algemene navigatievenster bestaat uit:
   * Navigatie - Vertegenwoordigd door een kompas
     ...
     | Console | Doel |
     |---|---|
     | Assets | Met deze consoles kunt u digitale elementen importeren en beheren, zoals afbeeldingen, video&#39;s, documenten en audiobestanden. Deze elementen kunnen vervolgens worden gebruikt door elke website die op hetzelfde AEM-exemplaar wordt uitgevoerd |
     | Gemeenschappen | Met deze console kunt u gemeenschapssites maken en beheren voor betrokkenheid en activering |
     | Commerce | Op deze manier kunt u producten, productcatalogi en bestellingen voor uw Commerce-sites beheren |
     ...
     | Sites | Met de Sites-consoles kunt u websites maken, weergeven en beheren die op uw AEM-instantie worden uitgevoerd. Via deze consoles kunt u webpagina&#39;s maken, bewerken, kopiëren, verplaatsen en verwijderen, workflows starten en pagina&#39;s publiceren |
