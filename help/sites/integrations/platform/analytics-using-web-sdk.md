...
>[!INFO]
>
>Voor een uitvoerig begrip van het **Variabele 1} dossier van het het lusjebezit details in het document van de Verwijzing van het Ontwerp van de Oplossing (SDR), heb toegang tot de voltooide WKND-Specifieke versie voor download** [ hier.](./assets/Final-WKND-WebSDK-BRD-SDR.xlsx)
