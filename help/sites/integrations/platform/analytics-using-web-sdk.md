...
Nochtans, heeft dit Schema XDM geen Adobe Analytics-Specifieke gebiedsgroepen om de eVar, gebeurtenisgegevens te verzenden. Er wordt een nieuw XDM-schema gemaakt in plaats van het bestaande schema bij te werken, zodat de eVar, gebeurtenisgegevens niet in het platform worden opgeslagen.
