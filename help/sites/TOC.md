...
+ Edge Delivery Services{#edge-delivery-services}
   ...
   + Ontwikkelen{#developing}
      ...
      + [Configuratiepijplijn](edge-delivery-services/developing/cloud-manager-configuration-pipeline.md)
      + Universele editor {#universal-editor}
         ...
         + Hoe kan ik{#how-to}
            ...
            + [Voorvertoning van lokale extensie](./edge-delivery-services/developing/universal-editor/how-to/local-extension-preview.md)
   + Hoe kan ik{#how-to}
