...
1. Werk de waarden bij zoals vereist door uw project. Zie __SAML 2.0 OSGi van de de configuratieverklaringsverklarende woordenlijst van de Authentificatie OSGi__ hierboven voor beschrijvingen van het configuratiebezit. `path` zou de inhoudsomslagen moeten bevatten die door Gesloten Gebruikersgroepen (CUGs) worden beschermd en authentificatie vereisen en deze authentificatiemanager zou voor het beschermen moeten verantwoordelijk zijn.
