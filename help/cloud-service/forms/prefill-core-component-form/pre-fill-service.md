...
# DataProvider-interface implementeren

Creeer een project van AEM gebruikend het recentste archetype en voeg de volgende code aan het project toe.
Doorgaans worden de gegevens opgehaald van een externe gegevensbron, zoals een database, Azure Storage, S3 bucket of een andere bron. U moet de code schrijven om de gegevens op te halen.
...
Neem de volgende code op in uw project. De bovenstaande code maakt gebruik van deze klasse DataManager
...
U kunt de code in uw lokale cloud-omgeving of in de cloud-instantie implementeren met behulp van cloudbeheer.
