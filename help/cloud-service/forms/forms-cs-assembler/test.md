...
* Het project bevat de volgende mappen in de bronnenmap:
   ...
   * pdffiles - Deze map bevat de PDF-bestanden die u wilt samenstellen
...
* Open ExecuteAssemblerService.java. Stel de waarde van de variabele assemblyURL zodanig in dat deze naar de instantie wijst.
