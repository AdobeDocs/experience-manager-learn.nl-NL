---
title: Inhoudsfragment exporteren naar XML
description: Leer hoe u een inhoudsfragment kunt exporteren vanuit de AEM Content Fragment Editor
...
| ------------------------ | --------------------- | 
| [Console voor inhoudsfragment](https://developer.adobe.com/uix/docs/services/aem-cf-editor/) | [Menu Koptekst](https://developer.adobe.com/uix/docs/services/aem-cf-editor/api/header-menu/) |

## Voorbeeldextensie

In het volgende voorbeeld wordt een knop in het headermenu gemaakt met twee subitems: een om het actieve inhoudsfragment als XML te exporteren (geïmplementeerd) en een om het actieve inhoudsfragment als CSV te exporteren (niet geïmplementeerd).

De code toont hoe de inhoud van het inhoudsfragment kan worden verkregen in het registratiebestand van de extensie en hoe de JSON-inhoud van het inhoudsfragment kan worden getransformeerd.
