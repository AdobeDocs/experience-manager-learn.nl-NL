...
+ [Meer informatie over het afstemmen van queryprestaties](https://experienceleague.adobe.com/docs/experience-manager-65/developing/bestpractices/troubleshooting-slow-queries.html?lang=nl-NL#query-performance-tuning){target="_blank"}
...
+ [Leer hoe u bestaande indexen kunt aanpassen](https://experienceleague.adobe.com/docs/experience-manager-65/developing/bestpractices/troubleshooting-slow-queries.html?lang=nl-NL#query-performance-tuning){target="_blank"}
+ [Leer hoe u indexen maakt](https://experienceleague.adobe.com/docs/experience-manager-65/developing/bestpractices/troubleshooting-slow-queries.html?lang=nl-NL#create-a-new-index){target="_blank"}
...
Als slechts [&#x200B; aanpassingen aan de vraag &#x200B;](#adjust-the-query) worden gemaakt, kan de vraag direct op AEM as a Cloud Service via Developer Console worden getest [&#x200B; verklaart Vraag &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/developer-console.html?lang=nl-NL#queries){target="_blank"}. Verklaar de looppas van de Vraag tegen de dienst van de Auteur van AEM, echter aangezien de indexdefinities het zelfde over de Auteur en de Publish diensten zijn, volstaat het bevestigen van vragen tegen de dienst van de Auteur van AEM.
