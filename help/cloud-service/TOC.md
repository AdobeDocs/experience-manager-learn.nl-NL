...
+ AI {#ai}
   ...
   + [Instellen en provisioning](./ai/setup.md)
   + AI-assistent {#ai-assistant}
      + [Overzicht](./ai/ai-assistant/overview.md)
      + [Wat is AI Assistant?](./ai/ai-assistant/what-is-ai-assistant.md)
      + [Voor wie is AI Assistant?](./ai/ai-assistant/who-is-ai-assistant-for.md)
      + [Belangrijkste mogelijkheden](./ai/ai-assistant/key-capabilities.md)
      + [AI-assistent en AI](./ai/ai-assistant/ai-assistant-and-agentic-ai.md)
   + Medewerkers {#agents}
      + [Overzicht](./ai/agents/agents-in-aem.md)
      + [Problemen met Dev Agent en CI/CD oplossen](./ai/agents/development-agent-troubleshoot-ci-cd-pipeline.md)
...
+ Ontwikkelen{#developing}
   ...
   + Geavanceerd{#advanced}
      ...
      + [Verouderde API&#39;s zoeken en verwijderen](./developing/advanced/deprecated-apis-find-removal.md)
...
+ Verificatie{#authentication}
   ...
   + [SAML-aanmeldhaken](./authentication/saml-2-0-login-hook.md)
...
+ Forms{#forms}
   ...
   + Profiel maken in AEP bij het verzenden van formulieren{#aep-integration}
      + [Inleiding](./forms/aep-integration/introduction.md)
      + [Cloudconfiguratie maken](./forms/aep-integration/create-cloud-configuration.md)
      + [Formulier configureren voor AEP-verzending](./forms/aep-integration/create-integration-with-aep.md)
   + Zelfstudie interactieve communicatie{#interactive-communication-tutorial}
      + [&#x200B;1. Inleiding](./forms/interactive-communication-tutorial/introduction.md)
      + [&#x200B;2. FDM maken](./forms/interactive-communication-tutorial/create-form-data-model.md)
      + [&#x200B;3. Sjabloon maken](./forms/interactive-communication-tutorial/create-template.md)
      + [&#x200B;4. Fragmenten maken](./forms/interactive-communication-tutorial/create-fragments.md)
      + [&#x200B;5. IC-document maken](./forms/interactive-communication-tutorial/create-ic-document.md)
      + [&#x200B;6. IC-document genereren](./forms/interactive-communication-tutorial/test-document-generation.md)
   ...
   + Azure Portal-opslag{#forms-cs-azure-portal}
   ...
   + Formuliervulling opslaan en hervatten{#prefill-azure-storage}
      ...
      + [4- Azure-opslagintegratie maken](./forms/prefill-azure-storage/create-fdm.md)
