...
1. Het `routes/update-product-attributes.js` dossier verifieert als de 1} Uitdrukkelijke zitting van de gebruiker [ een toegangstoken heeft. ](https://www.npmjs.com/package/express-session) Als dat niet het geval is, leidt het de gebruiker om naar de `/auth` route.
