...
description: Meer informatie over Cloud Manager for AEM as a Cloud Service en de verschillen met Cloud Manager for AEM op Adobe Manage Services (AMS).
...
>[!VIDEO](https://video.tv.adobe.com/v/3453901?captions=dut&quality=12&learn=on)
...
"><img alt="Hands-on opslagplaats van GitHub" src="./assets/github.png"/>
        ...
        <td style="width:100%;margin-bottom:1rem;">
            ...
            <p style="margin:1rem 0">
                Ontdek het activeren van een Cloud Manager-pijplijn met de AIO CLI Cloud Manager plug-in.
            </p>
            <a  rel="noreferrer"
                target="_blank"
                href="https://github.com/adobe/aem-cloud-engineering-video-series-exercises/tree/session4-cloud-manager#bootcamp-session-4-cloud-manager-develop-and-deploy
" class="spectrum-Button spectrum-Button--primary spectrum-Button--sizeM">
                <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> probeert uit Cloud Manager </span>
            </a>
        </td>
    </tr>
</table>
