...
1. [ Download en installeer recentste Java™ JDK 21 ](https://experience.adobe.com/#/downloads/content/software-distribution/en/general.html?fulltext=java*+21*&orderby=%40jcr%3Acontent%2Fjcr%3AlastModified&orderby.sort=desc&layout=list&p.offset=0&p.limit=11)
1. Controleer of Oracle Java™ 21 JDK is geïnstalleerd door de opdracht uit te voeren:
...
>[!CAUTION]
>
>Als u een oudere versie van AEM SDK in werking stelt, zou u Java 11 JDK [ in plaats daarvan kunnen moeten ](https://experience.adobe.com/#/downloads/content/software-distribution/en/general.html?fulltext=java*+11*&orderby=%40jcr%3Acontent%2Fjcr%3AlastModified&orderby.sort=desc&layout=list&p.offset=0&p.limit=11) downloaden. Het is echter aan te raden de nieuwste versie van AEM SDK te gebruiken.
...
1. Heb toegang tot de lokale Dienst van de Auteur van AEM in [ http://localhost :4502 ](http://localhost:4502) in browser van het Web. Wanneer u de eerste keer start, moet u mogelijk een paar minuten wachten tot de installatie is voltooid. Doorgaans wordt automatisch een browsertabblad geopend.
...
1. U kunt uw project van AEM of een steekproef [ Project van de Plaatsen van AEM KND ](https://github.com/adobe/aem-guides-wknd) aan lokale runtime van AEM klonen en opstellen gebruikend de volgende bevelen:
...
1. U kunt de gepubliceerde inhoud weergeven op `http://localhost:4503/<your-page-path>.html` . Meestal hoeft u zich niet aan te melden bij de service Publiceren om de gepubliceerde inhoud weer te geven. Nochtans, als u om het even welke kwesties of overzichtslogboeken ontmoet, vormt, enz., kunt u login aan de Publish dienst in [ http://localhost :4503 /libs/granite/core/content/login.html ](http://localhost:4503/libs/granite/core/content/login.html).
...
AEM as a Cloud Service heeft Java™ JDK 21 nodig en u gebruikt een andere versie. Waarschijnlijk Java™ 11 of 8. Om deze kwestie op te lossen, download en installeer [ Oracle Java™ JDK 21 ](https://experience.adobe.com/#/downloads/content/software-distribution/en/general.html?fulltext=Java*+21*&orderby=%40jcr%3Acontent%2Fjcr%3AlastModified&orderby.sort=desc&layout=list&p.offset=0&p.limit=11).

Nadat Oracle Java™ 21 JDK is geïnstalleerd, controleert u of dit de actieve versie is door de opdracht via de opdrachtregel uit te voeren:
