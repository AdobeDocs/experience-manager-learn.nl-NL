...
1. Ga als volgt te werk om de CDN-raakverhouding in cache en URL&#39;s als bovenste URL te identificeren:
   ...
   1. Open het **dashboard van de Verhouding van het Bezit van het Geheime voorgeheugen CDN {door het top-linker hoek** Menu van de Navigatie > Analyses > Dashboard > CDN het Verhouding van het Geheime voorgeheugen CDN _te klikken._
...
Het project van AEM WKND heeft een verwijzingsCDN configuratie, voor meer informatie, zie [ Configuratie 0} CDN van het ](https://github.com/adobe/aem-guides-wknd/blob/main/dispatcher/src/conf.d/available_vhosts/wknd.vhost#L137-L190) dossier.`wknd.vhost`
