...
1. Open het bestand `cdn.yaml` vanuit de hoofdmap van uw AEM-project van `config` . Bijvoorbeeld, het {[ dossier 1} van cdn.yaml van het 0} WKND-project.](https://github.com/adobe/aem-guides-wknd/blob/main/config/cdn.yaml)
