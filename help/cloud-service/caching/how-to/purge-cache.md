...
>[!VIDEO](https://video.tv.adobe.com/v/3436934?captions=dut&quality=12&learn=on)
...
1. Open het bestand `cdn.yaml` vanuit de hoofdmap van uw AEM-project van `config` . Bijvoorbeeld, het {[&#x200B; dossier 1} van cdn.yaml van het 0&rbrace; WKND-project.](https://github.com/adobe/aem-guides-wknd/blob/main/config/cdn.yaml)
