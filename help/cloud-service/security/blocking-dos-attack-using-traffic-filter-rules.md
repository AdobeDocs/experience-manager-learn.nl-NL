...
- Gebruik de Uitgebreide Veiligheid (vroeger genoemd Bescherming WAF-DDoS) of Uitgebreide Veiligheid voor Gezondheid (vroeger genoemd Verbeterde Veiligheid) toe:voegen-op en voer Adobe-geadviseerde [ Regels van de Filter van het Verkeer van WAF ](./traffic-filter-and-waf-rules/use-cases/using-waf-rules.md) uit om tegen verfijnde aanvallen, met inbegrip van die te verdedigen die geavanceerde protocol of op lading-gebaseerde technieken gebruiken.
