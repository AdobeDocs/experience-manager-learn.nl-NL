...
Het [ hulpmiddelhulp van de Generator van de Definitie van de Index van 0} Oak ](https://thomasmueller.github.io/oakTools/indexDefGenerator.html) om de indexdefinitie **te produceren die op de inputvragen wordt gebaseerd.** Het is een goed beginpunt om een aangepaste index te maken.
