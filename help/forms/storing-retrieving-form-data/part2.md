...
# servlet maken om formuliergegevens op te slaan

De volgende stap bestaat uit het maken van een servlet die formuliergegevens invoegt of bijwerkt. In regel 26 wordt verwezen naar de Apache Sling Connection Pooled DataSource die in de vorige stap is geconfigureerd. De rest van de code is vrij eenvoudig. De code voegt een nieuwe rij in de database in of werkt een bestaande rij bij. De opgeslagen Adaptieve gegevens van de Vorm worden geassocieerd met een GUID. Dezelfde GUID wordt vervolgens gebruikt om de formuliergegevens bij te werken.
