...
CustomRoutes ArrayList wordt dan gebruikt om de Routes in de AssignTask component![customroutes](assets/arraylist.jpg)Zodra de variabele CustomRoutes ArrayList met de waarden van de voorgelegde gegevens wordt geïnitialiseerd, worden de Routes van de AssignTask component dan bevolkt gebruikend de variabele CustomRoutes. Het schermafbeelding hieronder toont u de aangepaste routes in een AssignTask![-taak](assets/customactions.jpg)
...
* [Het ZIP-bestand](assets/arraylistvariable.zip) importeren met AEM Package Manager
