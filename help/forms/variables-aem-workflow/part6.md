...
De volgende code die aan een stap van het douaneproces wordt geassocieerd registreert de waarde van alle types van variabelen behalve van type FormDataModel.
...
[De variabele-loggerbundel implementeren](assets/VariableLogger.core-1.0.0-SNAPSHOT.jar) met de Felix-webconsole.
