...
# Zoeken in AEM Assets{#using-search-in-aem-assets} gebruiken
...
## Geavanceerde configuratie van voorspellingen voor multiwaarde- en tagzoekopdrachten {#multi-value-tag-predicates}

De **zoekvoorspelling voor meerdere waarden** is beschikbaar voor eenvoudige tekstafstemming in zoekresultaten. Er zijn verschillende verbeteringen aangebracht in de tagvoorspelling om de zoekresultaten van middelen efficiënter te filteren.
