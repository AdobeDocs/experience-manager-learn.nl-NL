...
+ Authoring{#authoring}
   ...
   + [Relatief en los van elkaar](./authoring/relate-unrelate.md)
...
+ Zoeken en detecteren{#search-and-discovery}
   ...
   + [&#x200B; AI onderzoek &#x200B;](./search-and-discovery/ai-search.md)
...
+ Content Hub{#content-hub}
   ...
   + [Configureren](./content-hub/configure.md)
   + [Elementen toevoegen](./content-hub/add-assets.md)
   + [Elementen downloaden](./content-hub/download-assets.md)
   ...
   + [Toegangsbeheer op basis van kenmerken](./content-hub/attribute-based-access-control.md)
...
+ Adobe Asset Link{#adobe-asset-link}
   ...
   + [Versieringen en opmerkingen](./adobe-asset-link/file-versioning-and-comments.md)
   + [Kopie plaatsen](./adobe-asset-link/place-copy.md)
   + [Gekoppeld plaatsen](./adobe-asset-link/place-linked.md)
...
+ Dynamische media{#dynamic-media}
   ...
   + Afbeeldingen {#images}
      + [URL-syntaxis en voorinstellingen voor afbeeldingen](dynamic-media/dynamic-media-urls-and-image-presets.md)
      + [Afbeeldingsautomatisering](dynamic-media/dynamic-media-image-automation.md)
   ...
   + Tutorials {#tutorials}
      ...
      + [Afbeeldingsprofielen voor slim uitsnijden maken](dynamic-media/tutorials/creating-image-profile-smart-crop.md)
      + [Videoprofielen maken](dynamic-media/tutorials/creating-video-profile-to-process-videos-in-dynamic-media.md)
      + [Bezig met verwerken van elementen](dynamic-media/tutorials/how-to-run-dam-update-asset-workflow-on-an-asset-with-dynamic-media-enabled.md)
